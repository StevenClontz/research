...
\section{Introduction}
  ...
  But \(CH\) is not required to have \(\alcompS{\aleph_2}\) fail.
            ...
            finite chains of subset of $\omega$. We consider any  family of
            ...
            Now fix any  $\mu<\lambda$ so that
             $\operatorname{supp}(\dot
             f_{[\lambda,\lambda+\omega)})\cap \lambda\subset \mu$.
            ...
            f_{[\lambda,\lambda+\omega)}$,
             we have that $(\,(k,m),\varphi_{\mu,\lambda}(p))$ is in $F_H$.
...
% \end{figure}
  ...
  Although, one may consider the following question.
