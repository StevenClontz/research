...
\begin{abstract}
  As shown by Telgarsky and Scheepers,
...
\node at (-3.5,0) {\(\pl F \ktactwin{(k+1)}\schFillStrictGame\kappa\)};
% \node at (0,2) {\(\alcompSP\kappa\)};
\node at (-1.1,1) {\(\pl F \kmarkwin{(k+1)}\menGame{\onePtLind\kappa}\)};
\node at (0,1) {\(\Leftrightarrow\)};
\node at (1,1) {\(\pl F \kmarkwin{(k+1)}\schFillIntGame\kappa\)};
\node at (-1,0) {\(\pl F \kmarkwin{(k+1)}\schFillInitialGame\kappa\)};
\node at (0,0) {\(\Leftrightarrow\)};
\node at (1,0) {\(\pl F \kmarkwin{(k+1)}\schFillGame\kappa\)};
\node at (0,-1) {\(\pl F \kmarkwin{(k+1)}\schFillStrictGame\kappa\)};
% \draw[-implies,double equal sign distance] (-3.2,2) -- (-0.3,2);
\draw[-implies,double equal sign distance] (-2.5,0) -- (-2,0);
...
\draw[-implies,double equal sign distance] (-3.2,1) -- (-1.9,1);
\draw[-implies,double equal sign distance] (-2.6,0) -- (-1.9,0);
\draw[-implies,double equal sign distance] (-3.5,0.65) -- (-3.5,0.35);
% \draw[-implies,double equal sign distance] (0,1.65) -- (0,1.35);
\draw[-implies,double equal sign distance] (0,0.65) -- (0,0.35);
\draw[-implies,double equal sign distance] (0,-0.35) -- (0,-0.65);
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  \draw[implies-implies,double equal sign distance]
    (m-1-1) -- (m-2-1);
  \draw[implies-implies,double equal sign distance]
    (m-1-2) -- (m-2-2);
  \draw[implies-implies,double equal sign distance]
  ...
  \draw[-implies,double equal sign distance]
    (m-1-1) -- (m-1-2);
  \draw[-implies,double equal sign distance]
    (m-2-1) -- (m-2-2);
  \draw[-implies,double equal sign distance]
  ...
  \draw[-implies,double equal sign distance,bend right=30]
    (m-1-2) -- node {\( \not \)} (m-1-1);
...
\end{tikzpicture}
\end{center}
\caption{Diagram of covering properties related to the Menger game TODO FIX}
\label{menSpec}
\end{figure}
...
\begin{proof}
  ...
  Let \(\mc U=\{U_\alpha:\alpha<\kappa\}\) be an
  open cover of \(\text{cl}_X(Y)\); for \(y\in Y\), apply regularity to get
  \(V_\alpha\subseteq\text{cl}_X(V_\alpha)\subseteq U_\alpha\)
  with \(V_\alpha\) open.
  Use relative compactness to obtain a finite subcollection of
  \(\{X\setminus\text{cl}_X(Y)\}\cup\{V_\alpha:\alpha<\kappa\}\)
  covering \(Y\): \(\{V_{\alpha_i}:i<n\}\). Then since
  \(\bigcup\{\text{cl}_X(V_{\alpha_i}):i<n\}\) is a closed set in \(X\)
  containing \(Y\), it contains \(\text{cl}_X(Y)\), and thus
  \(\{U_{\alpha_i}:i<n\}\) is a finite subcollection of \(\mc U\) covering
  \(\text{cl}_X(Y)\).
