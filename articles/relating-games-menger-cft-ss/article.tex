...
\begin{proposition}
  ...
  \(\Omega M^+,\Omega M^{\plusMark}\))
  may be improved so that any final sequence of the chosen
...
\begin{proof}
  ...
  \). For \(\Omega M^{\plusMark}\), the winning Markov strategy \(\sigma\) may
...
but not even \(CDFT^{\plusMark}\). To do so, we will find a space \(X\)
