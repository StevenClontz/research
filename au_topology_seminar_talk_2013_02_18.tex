...
Let $\mc{B}$ be a clopen base for $X$ of cardinality $\leq 2^\omega$ which is a refinement of $\mc{V}$.  Then as $X$ is metaLindel\"of, locally Lindel\"of, and regular, by Thm \ref{michael}, let $\mc{U}\subseteq \mc{B}$ be a point-countable clopen refinement of $\mc{V}$ of cardinality $2^\omega$, which cannot be $\sigma$-point-finite.

% TODO finish this for \leq 2^\omega
\end{proof}

\begin{definition}
Using the $X$ from Theorem \ref{basic_x}, let \[\mathbb{X} = (X \times 2^{<\omega}) \cup 2^\omega\] compose a topological sum of $2^{<\omega}$ copies of $X$ along with a discrete copy of the Cantor Set $\leq 2^\omega$, and add open (in fact, compact) neighborhoods of the form: 
  \[
