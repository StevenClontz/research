...
\begin{document}
  ...
  \begin{proof}
    ...
    \begin{itemize}
      ...
      We define a strategy for $P$ in $\altrothgame{X}$ as follows: during round $0$, $P$ chooses a point $x_0$ for which every open neighborhood is of the form $U_0 = \sigma(\mc{U}_0)$ for some open cover $\mc{U}_0$. (If not, let $U_x$ witness for every $x\in X$, and note that $\sigma(\{U_x:x\in X\})$ is a contradiction.)
