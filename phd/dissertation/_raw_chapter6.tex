...
\newpage
  ...
  \begin{proof}
    % $(c)\Rightarrow(b)\Rightarrow(a)$ are all trivial. Galvin has shown $(a) \Leftrightarrow P\win\rothAltGame{X} \Rightarrow (c)$ in \textit{Indeterminacy}, but a direct proof of $(a)\Rightarrow(c)$ follows.
