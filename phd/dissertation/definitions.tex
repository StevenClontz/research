...
\newcommand{\bellConGame}[1]{Bell_{D,P}^{\to}(#1)}
\newcommand{\bellConHardGame}[1]{Bell_{D,P}^{\to,\star}(#1)}
\newcommand{\bellClusGame}[1]{Bell_{D,P}^{\leadsto}(#1)}
\newcommand{\bellClusHardGame}[1]{Bell_{D,P}^{\leadsto,\star}(#1)}
\newcommand{\bellAbsConGame}[1]{Bell_{D,P}^{\mapsto}(#1)}
\newcommand{\bellAbsConHardGame}[1]{Bell_{D,P}^{\mapsto,\star}(#1)}
