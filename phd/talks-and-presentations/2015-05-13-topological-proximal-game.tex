...
\begin{frame}
  ...
  So we topologize Bell's game by simply calling the open symmetric
  neighborhoods of the diagonal with the above property ``entourages'',
...
\begin{frame}
  ...
  but \(\pl D\tactwin\bellAbsConGame{X}\) implies zero-dimensionality for
  compact spaces.
  \end{itemize}
\end{frame}
